...
export default class Convert {
    static toOilGasDataSource(json: any): OilGasDataSource {
        return cast(json, r("OilGasDataSource"));
    }

    static oilGasDataSourceToJson(value: OilGasDataSource): any {
        return uncast(value, r("OilGasDataSource"));
    }

    static toOilGasDb(json: any): OilGasDb {
        return cast(json, r("OilGasDb"));
    }

    static oilGasDbToJson(value: OilGasDb): any {
        return uncast(value, r("OilGasDb"));
    }

    static toWell(json: any): Well {
        return cast(json, r("Well"));
    }

    static wellToJson(value: Well): any {
        return uncast(value, r("Well"));
    }

    static toCompany(json: any): Company {
        return cast(json, r("Company"));
    }

    static companyToJson(value: Company): any {
        return uncast(value, r("Company"));
    }

    static toCompletionDetails(json: any): CompletionDetails {
        return cast(json, r("CompletionDetails"));
    }

    static completionDetailsToJson(value: CompletionDetails): any {
        return uncast(value, r("CompletionDetails"));
    }

    static toPerforationIntervalRecord(json: any): PerforationIntervalRecord {
        return cast(json, r("PerforationIntervalRecord"));
    }

    static perforationIntervalRecordToJson(value: PerforationIntervalRecord): any {
        return uncast(value, r("PerforationIntervalRecord"));
    }

    static toPerforationInterval(json: any): PerforationInterval {
        return cast(json, r("PerforationInterval"));
    }

    static PerforationIntervalToJson(value: PerforationInterval): any {
        return uncast(value, r("PerforationInterval"));
    }

    static toField(json: any): Field {
        return cast(json, r("Field"));
    }

    static fieldToJson(value: Field): any {
        return uncast(value, r("Field"));
    }

    static toLocation(json: any): Location {
        return cast(json, r("Location"));
    }

    static locationToJson(value: Location): any {
        return uncast(value, r("Location"));
    }

    static toMonthlyProductionRecord(json: any): MonthlyProductionRecord {
        return cast(json, r("MonthlyProductionRecord"));
    }

    static monthlyProductionRecordToJson(value: MonthlyProductionRecord): any {
        return uncast(value, r("MonthlyProductionRecord"));
    }

    static toMonthlyProduction(json: any): MonthlyProduction {
        return cast(json, r("MonthlyProduction"));
    }

    static MonthlyProductionToJson(value: MonthlyProduction): any {
        return uncast(value, r("MonthlyProduction"));
    }

    static toReservoirData(json: any): ReservoirData {
        return cast(json, r("ReservoirData"));
    }

    static reservoirDataToJson(value: ReservoirData): any {
        return uncast(value, r("ReservoirData"));
    }

    static toWellboreDetails(json: any): WellboreDetails {
        return cast(json, r("WellboreDetails"));
    }

    static wellboreDetailsToJson(value: WellboreDetails): any {
