...
export module data {
    ...
    export default class DefaultSQExprVisitorWithArg<T, TArg> implements ISQExprVisitorWithArg<T, TArg> {
    ...
    export default class DefaultSQExprVisitor<T> extends DefaultSQExprVisitorWithArg<T, void> implements ISQExprVisitor<T> {}

    /** Default ISQExprVisitor implementation that implements default traversal and that others may derive from. */
    export default class DefaultSQExprVisitorWithTraversal implements ISQExprVisitor<void> {
