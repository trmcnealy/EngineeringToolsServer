...
export module data {
    ...
    export /*abstract*/ class SQExpr {
        ...
        public getDefaultAggregate(federatedSchema: FederatedConceptualSchema, forceAggregation: boolean = false): QueryAggregateFunction {
            ...
            if (property && property.kind === ConceptualPropertyKind.Column) {
                ...
                if ((property.type.integer || property.type.numeric) && propertyDefaultAggregate !== ConceptualDefaultAggregate.None) {
        ...
        private getPropertyKeys(schema: FederatedConceptualSchema): ArrayNamedItems<ConceptualProperty> {
        ...
        private getMetadataForProperty(field: SQFieldDef, federatedSchema: FederatedConceptualSchema): SQExprMetadata {
            ...
            switch (field.aggregate) {
                ...
                case QueryAggregateFunction.Avg:
                    if (type.integer) type = ValueType.fromExtendedType(ExtendedType.Double);
                    break;
            }
        ...
        private static getMetadataForEntity(field: SQFieldDef, federatedSchema: FederatedConceptualSchema): SQExprMetadata {
            ...
            if (field.aggregate === QueryAggregateFunction.Count || field.aggregate === QueryAggregateFunction.CountNonNull) {
                return {
    ...
    export function defaultAggregateForDataType(type: ValueType): QueryAggregateFunction {
        if (type.integer || type.numeric) return QueryAggregateFunction.Sum;
    ...
    export default class SQEntityExpr extends SQExpr {
    ...
    export default class SQColumnRefExpr extends SQPropRefExpr {
        constructor(source: SQExpr, ref: string) {
            super(source, ref);
        }
    ...
    export default class SQMeasureRefExpr extends SQPropRefExpr {
        constructor(source: SQExpr, ref: string) {
            super(source, ref);
        }
    ...
    export default class SQAggregationExpr extends SQExpr {
        public arg: SQExpr;
    ...
    export default class SQAndExpr extends SQExpr {
        left: SQExpr;
        right: SQExpr;
    ...
    export default class SQBetweenExpr extends SQExpr {
        arg: SQExpr;
        lower: SQExpr;
        upper: SQExpr;
    ...
    export default class SQInExpr extends SQExpr {
        args: SQExpr[];
        values: SQExpr[][];
    ...
    export default class SQOrExpr extends SQExpr {
        left: SQExpr;
        right: SQExpr;
    ...
    export default class SQCompareExpr extends SQExpr {
    ...
    export default class SQContainsExpr extends SQExpr {
        left: SQExpr;
        right: SQExpr;
    ...
    export default class SQStartsWithExpr extends SQExpr {
        left: SQExpr;
        right: SQExpr;
    ...
    export default class SQExistsExpr extends SQExpr {
        arg: SQExpr;
    ...
    export default class SQNotExpr extends SQExpr {
        arg: SQExpr;
    ...
    export default class SQConstantExpr extends SQExpr {
    ...
    export default class SQDateSpanExpr extends SQExpr {
    ...
    export default class SQDateAddExpr extends SQExpr {
        public unit: TimeUnit;
    ...
    export default class SQNowExpr extends SQExpr {
        constructor() {
            super();
        }
    ...
    export module SQExprBuilder {
        ...
        export function nullConstant(): SQConstantExpr {
            return new SQConstantExpr(ValueType.fromExtendedType(ExtendedType.Null), null, PrimitiveValueEncoding.nullEncoding());
        }
        ...
        export function boolean(value: boolean): SQConstantExpr {
            return new SQConstantExpr(ValueType.fromExtendedType(ExtendedType.Boolean), value, PrimitiveValueEncoding.boolean(value));
        }
        ...
        export function dateTime(value: Date, valueEncoded?: string): SQConstantExpr {
            if (valueEncoded === undefined) valueEncoded = PrimitiveValueEncoding.dateTime(value);
        ...
        export function decimal(value: number, valueEncoded?: string): SQConstantExpr {
            if (valueEncoded === undefined) valueEncoded = PrimitiveValueEncoding.decimal(value);
        ...
        export function double(value: number, valueEncoded?: string): SQConstantExpr {
            if (valueEncoded === undefined) valueEncoded = PrimitiveValueEncoding.double(value);
        ...
        export function integer(value: number, valueEncoded?: string): SQConstantExpr {
            if (valueEncoded === undefined) valueEncoded = PrimitiveValueEncoding.integer(value);
        ...
        export function text(value: string, valueEncoded?: string): SQConstantExpr {
            ...
            return new SQConstantExpr(ValueType.fromExtendedType(ExtendedType.Text), value, valueEncoded || PrimitiveValueEncoding.text(value));
        }
        ...
        export function createExprWithAggregate(expr: SQExpr, schema: FederatedConceptualSchema, aggregateNonNumericFields: boolean): SQExpr {
    ...
    class SQExprEqualityVisitor implements ISQExprVisitorWithArg<boolean, SQExpr> {
        ...
        public visitColumnRef(expr: SQColumnRefExpr, comparand: SQColumnRefExpr): boolean {
            return comparand instanceof SQColumnRefExpr && expr.ref === (<SQColumnRefExpr>comparand).ref && this.equals(expr.source, (<SQColumnRefExpr>comparand).source);
        }

        public visitMeasureRef(expr: SQMeasureRefExpr, comparand: SQMeasureRefExpr): boolean {
            return comparand instanceof SQMeasureRefExpr && expr.ref === (<SQMeasureRefExpr>comparand).ref && this.equals(expr.source, (<SQMeasureRefExpr>comparand).source);
        }

        public visitAggr(expr: SQAggregationExpr, comparand: SQExpr): boolean {
            return comparand instanceof SQAggregationExpr && expr.func === (<SQAggregationExpr>comparand).func && this.equals(expr.arg, (<SQAggregationExpr>comparand).arg);
        }
        ...
        public visitIn(expr: SQInExpr, comparand: SQExpr): boolean {
            if (!(comparand instanceof SQInExpr) || !this.equalsAll(expr.args, (<SQInExpr>comparand).args)) return false;
        ...
        public visitAnd(expr: SQAndExpr, comparand: SQExpr): boolean {
            return comparand instanceof SQAndExpr && this.equals(expr.left, (<SQAndExpr>comparand).left) && this.equals(expr.right, (<SQAndExpr>comparand).right);
        }

        public visitOr(expr: SQOrExpr, comparand: SQExpr): boolean {
            return comparand instanceof SQOrExpr && this.equals(expr.left, (<SQOrExpr>comparand).left) && this.equals(expr.right, (<SQOrExpr>comparand).right);
        }
        ...
        public visitContains(expr: SQContainsExpr, comparand: SQExpr): boolean {
            return (
                comparand instanceof SQContainsExpr && this.equals(expr.left, (<SQContainsExpr>comparand).left) && this.equals(expr.right, (<SQContainsExpr>comparand).right)
            );
        }

        public visitDateSpan(expr: SQDateSpanExpr, comparand: SQExpr): boolean {
            return comparand instanceof SQDateSpanExpr && expr.unit === (<SQDateSpanExpr>comparand).unit && this.equals(expr.arg, (<SQDateSpanExpr>comparand).arg);
        }
        ...
        public visitExists(expr: SQExistsExpr, comparand: SQExpr): boolean {
            return comparand instanceof SQExistsExpr && this.equals(expr.arg, (<SQExistsExpr>comparand).arg);
        }

        public visitNot(expr: SQNotExpr, comparand: SQExpr): boolean {
            return comparand instanceof SQNotExpr && this.equals(expr.arg, (<SQNotExpr>comparand).arg);
        }
    ...
    export default class SQExprValidationVisitor extends SQExprRewriter {
        ...
        public visitColumnRef(expr: SQColumnRefExpr): SQExpr {
            ...
            if (fieldDef) {
                ...
                if (entity) {
                    ...
                    if (!prop || prop.kind !== ConceptualPropertyKind.Column || !this.isQueryable(fieldDef)) this.register(SQExprValidationError.invalidColumnReference);
                }
            }
            return expr;
        }
        ...
        public visitMeasureRef(expr: SQMeasureRefExpr): SQExpr {
            ...
            if (fieldDef) {
                ...
                if (entity) {
                    ...
                    if (!prop || prop.kind !== ConceptualPropertyKind.Measure || !this.isQueryable(fieldDef)) this.register(SQExprValidationError.invalidMeasureReference);
                }
            }
            return expr;
        }
        ...
        public visitAggr(expr: SQAggregationExpr): SQExpr {
            ...
            if (columnRefExpr) {
                ...
                if (supportedFuncs.indexOf(expr.func) < 0) this.register(SQExprValidationError.invalidAggregateFunction);
            }
        ...
        public visitContains(expr: SQContainsExpr): SQExpr {
            ...
            if (!(left instanceof SQColumnRefExpr)) this.register(SQExprValidationError.invalidLeftOperandType);
            else {
                this.visitColumnRef(<SQColumnRefExpr>left);
                if (!(right instanceof SQConstantExpr) || !(<SQConstantExpr>right).type.text) this.register(SQExprValidationError.invalidRightOperandType);
            }
