...
export default class ValueType implements ValueTypeDescriptor {
...
export default class TemporalType implements TemporalTypeDescriptor {
    private underlyingType: ExtendedType;
...
export default class GeographyType implements GeographyTypeDescriptor {
    private underlyingType: ExtendedType;
...
export default class MiscellaneousType implements MiscellaneousTypeDescriptor {
    private underlyingType: ExtendedType;
...
export default class FormattingType implements FormattingTypeDescriptor {
    private underlyingType: ExtendedType;
